...
<body>
    ...
    <div class="container">
        <h4>Xin chào, <?php echo $studentEmail; ?></h4>
        ...
        <div class="row" id="courseList">
            ...
            <div class="row">
                ...
                $sql = "SELECT Course.*, User_General.FullName AS TeacherName
        FROM Course
        INNER JOIN Teacher_Registration ON Course.course_ID = Teacher_Registration.course_ID
        INNER JOIN User_General ON Teacher_Registration.user_ID = User_General.user_ID
        WHERE Teacher_Registration.status = 'approved'
        LIMIT $viTriBatDau, $soLuongKhoaHocTrenMotTrang";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<p class="card-text">Chưa đăng kí: ' . (isset($row['course_AvailableSlot']) ? $row['course_AvailableSlot'] : 'Hết chỗ') . '</p>';
